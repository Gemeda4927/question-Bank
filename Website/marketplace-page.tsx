...
export default function MarketplacePage() {
  ...
  const checkEnrollmentStatus = async (course: Course): Promise<EnrollmentStatus> => {
    try {
      ...
      console.log("[v0] Checking enrollment for student:", currentStudentId, "in course:", course.name)
      ...
      console.log("[v0] Student not enrolled in course:", course.name)
      return {
        isEnrolled: false,
        hasPaid: false,
        enrolledExams: [],
  ...
  const fetchData = async () => {
    try {
      ...
      for (const course of allCourses) {
        ...
        console.log("[v0] Course enrollment status:", {
          course: course.name,
